...
const api = {
  ...
  updateDishToCategoryOfWeekday: async (weekday: Weekday, dish: Dish) => {
    ...
    const res = await WeekMenuController.updateDishToCategoryOfWeekday(
      weekday,
      dish,
    );
  ...
  deleteDishToCategoryOfWeekday: async (
    weekday: Weekday,
    category: DishCategory,
  ) => {
    log("deleteDishToCategoryOfWeekday: input", { weekday, category });
    const res = await WeekMenuController.deleteDishToCategoryOfWeekday(
      weekday,
      category,
    );
